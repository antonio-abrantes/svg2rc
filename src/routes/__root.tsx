  ...
  head: () => ({
    meta: [
      ...
      { title: "svg2rc — SVG para componente React" },
      {
        name: "description",
        content:
          "Converta SVG em componente React (JSX ou TSX) direto no navegador. Open source, 100% client-side.",
      },
      { name: "author", content: "svg2rc" },
